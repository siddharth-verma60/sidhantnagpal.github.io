...
This week, I started working on the convolution for <img src="https://latex.codecogs.com/gif.latex?2^n"/>`-group` using `fwht` - Dyadic (XOR) Convolution. The PR [#14783](https://github.com/sympy/sympy/pull/14783) dealt with this addition to the module.
